...
aws --endpoint-url=http://localhost:4566 s3api put-object --bucket demo-bucket --key bfdeft01/dpc/in/P.NGD.DPC.RSP.D240123.T1122001.IN --body=synthetic_test_data/P.NGD.DPC.RSP.D240123.T1122001.IN
