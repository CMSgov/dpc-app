...
test('generates an unsigned JWT and JWT with user input', () => {
  ...
  var publicKey = `-----BEGIN PUBLIC KEY-----\\n-----END PUBLIC KEY-----`;
...
// test('testing', () => {
//   var sJWS = KJUR.jws.JWS.sign(null, '{"alg":"HS256", "cty":"JWT"}', '{"age": 21}', {"utf8": "password"});
//   var jwsValid = KJUR.jws.JWS.verify(sJWS, {"utf8": "password"});
//   var isValid = KJUR.jws.JWS.verifyJWT(sJWS, {"utf8": "password"}, { alg: ['HS256', 'HS384'], iss: ['http://foo.com'] });
