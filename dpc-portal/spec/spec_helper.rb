...
# Configure Capybara to use Selenium standalone container for JS-dependent tests
require 'axe-rspec'
...
RSpec.configure do |config|
  ...
  config.before(:each) do
    stub_request(:any, /impl.idp.idm.cms.gov/).to_rack(FakeCpiGateway)
    stub_request(:any, /val.cpiapi.cms.gov/).to_rack(FakeCpiGateway)
  end
end
