...
RSpec.describe Page::Organization::TosFormComponent, type: :component do
  ...
  describe 'html' do
    ...
    let(:organization) { create(:provider_organization, name: 'Health Hut', npi: '1111111111', id: 2) }
    ...
    let(:expected_html) do
      <<~HTML
        <div>
          ...
          <p>Confirmed! We succesfully identified you as an Authorized Official (AO) of Health Hut (NPI 1111111111).</p>
          ...
          <div>
            <ul class="usa-button-group">
              <li class="usa-button-group__item">
                <form class="button_to" method="post" action="/portal/organizations/2/sign_tos"><button class="usa-button" type="submit">I have read and accepted the Terms of Service</button></form>
              </li>
              <li class="usa-button-group__item">
