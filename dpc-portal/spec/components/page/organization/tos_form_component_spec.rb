          ...
          <div>
            <ul class="usa-button-group">
              <li class="usa-button-group__item">
                <form class="button_to" method="get" action="/portal/organizations/place-holder/sign_tos"><button class="usa-button" type="submit">I have read and accepted the Terms of Service</button></form>
              </li>
              <li class="usa-button-group__item">
