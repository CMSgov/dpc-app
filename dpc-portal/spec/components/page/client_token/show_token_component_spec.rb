...
RSpec.describe Page::ClientToken::ShowTokenComponent, type: :component do
  ...
  describe 'html' do
    ...
    let(:expected_html) do
      <<~HTML
        <div>
          <div class="margin-top-5 margin-bottom-5">← <a href="/organizations/#{org.path_id}?credential_start=true">#{org.name}</a></div>
          ...
          <div>
            ...
            <form class="button_to" method="get" action="http://test.host/">
