...
public class DataService {
    ...
    public Bundle retrieveData(UUID organizationID, UUID providerID, List<String> patientIDs, ResourceType... resourceTypes) {
        ...
        if (optionalBatches.isEmpty()) {
            throw new DataRetrievalException("Failed to look back");
        }
