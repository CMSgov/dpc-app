...
public abstract class AbstractAttributionTest {
    ...
    protected static final DropwizardTestSupport<DPCAttributionConfiguration> APPLICATION = new DropwizardTestSupport<>(DPCAttributionService.class, "testing.conf", ConfigOverride.config(KEY_PREFIX, "", ""));
