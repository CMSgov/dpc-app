...
class ExpirationJobTest {
    ...
    private static final DropwizardTestSupport<DPCAttributionConfiguration> APPLICATION = new DropwizardTestSupport<>(DPCAttributionService.class, "testing.conf", ConfigOverride.config("server.applicationConnectors[0].port", "3727"));
