...
class BatchAggregationEngineTest {
    ...
    void setupEach() {
        ...
        final SuppressionEngine suppressionEngine = new MockSuppressionEngine();
        engine = new AggregationEngine(aggregatorID, bbclient, suppressionEngine, queue, fhirContext, metricRegistry, operationsConfig);
