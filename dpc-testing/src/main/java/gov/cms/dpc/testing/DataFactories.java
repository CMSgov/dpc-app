...
/**
 * A small collection of helper classes for creating fake (but valid) data for testing.
 * It's completely deterministic, but at least makes the FHIR parser happy
 */
