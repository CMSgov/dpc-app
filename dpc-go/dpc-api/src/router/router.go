...
func NewDPCAPIRouter(oc v2.Controller, mc v2.ReadController, gc v2.Controller, dc v2.FileController, jc v2.JobController, ic v2.Controller, implOrg v2.Controller) http.Handler {
	r := chi.NewRouter()
