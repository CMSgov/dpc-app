...
class UsaBannerComponent < ApplicationComponent
# Phlex doesn't support a bunch of svg tags, so we have to create our own
register_element :g
...
register_element :circle
  ...
  def template
    section(class: "ds-c-usa-banner", aria: {label: "Official government website"}) {
        header(class: "ds-c-usa-banner__header") {
            svg(
                ...
                title(id: "icon-2__title") {"U.S. Flag"}
                g(fill: "none", fill: {rule: "evenodd"}) {
                    ...
                    path(fill: "#FFF", d:"M1 1h1v1H1zM2 3h1v1H2zM1 5h1v1H1zM3 1h1v1H3zM4 3h1v1H4zM3 5h1v1H3zM5 1h1v1H5zM6 3h1v1H6zM5 5h1v1H5z")
                }
            }
            ...
            p(class: "ds-c-usa-banner__header-text") {
                ...
                button(
                    ...
                    aria: {expanded: "false", controls: "gov-banner_1"},
                    id: "usa-banner__button"
                ) {
                    span(class: "ds-c-usa-banner__button-text") {"Here’s how you know"}
                    svg(
                        aria: {hidden: "true"},
            ...
            div(class: "ds-c-usa-banner__guidance-container") {
                div(class: "ds-c-usa-banner__guidance") {
                    ...
                    p(class: "ds-c-usa-banner__media-body") {
                        ...
                        strong{".gov"}
                        whitespace
                        plain("website belongs to an official government organization in the United States.")
                    }
                }
                div(class: "ds-c-usa-banner__guidance") {
                    svg(
                        ...
                        path(fill: "currentColor", d: "M34.72,34.84a1.29,1.29,0,0,1-1.29,1.29H20.57a1.29,1.29,0,0,1-1.29-1.29V27.12a1.29,1.29,0,0,1,1.29-1.29H21V23.26a6,6,0,0,1,12,0v2.57h0.43a1.29,1.29,0,0,1,1.29,1.29v7.72Zm-4.29-9V23.26a3.43,3.43,0,0,0-6.86,0v2.57h6.86Z")
                        circle(
                            fill: "none",
                            stroke: "currentColor",
                            "stroke-width" => "1",
                    ...
                    p(class: "ds-c-usa-banner__media-body") {
                        ...
                        svg(
                            ...
                            path(fill: {rule: "evenodd"}, d: "M26 0c10.493 0 19 8.507 19 19v9h3a4 4 0 0 1 4 4v28a4 4 0 0 1-4 4H4a4 4 0 0 1-4-4V32a4 4 0 0 1 4-4h3v-9C7 8.507 15.507 0 26 0zm0 8c-5.979 0-10.843 4.77-10.996 10.712L15 19v9h22v-9c0-6.075-4.925-11-11-11z")
                        }
                        whitespace
                        plain("or")
                        whitespace
                        strong{"https://"}
                        whitespace
                        plain("means you’ve safely connected to the .gov website. Share sensitive information only on official, secure websites.")
                    }
                }
            }
        }
    ...
    script(type: "text/javascript") {
        # Using this prevents html escaping
        unsafe_raw(
        '
