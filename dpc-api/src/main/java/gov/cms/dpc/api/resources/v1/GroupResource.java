...
public class GroupResource extends AbstractGroupResource {
    ...
    public Response export(@ApiParam(hidden = true) @Auth OrganizationPrincipal organizationPrincipal,
        ...
        logger.info("dpcMetric=queueSubmitted,jobID={},orgId={},totalPatients={},resourcesRequested={},queueSubmitTime={}", jobID, orgID, totalPatients, resourcesRequested, eventTime);
