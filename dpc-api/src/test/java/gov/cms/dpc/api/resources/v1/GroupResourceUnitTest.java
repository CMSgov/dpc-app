...
public class GroupResourceUnitTest {
    ...
    public void testExportWithValidSinceParam(){
        ...
        Response response = resource.export(organizationPrincipal, groupId, null, null, Optional.of(new OffsetDateTimeParam(since)), "respond-async");
        ...
        response = resource.export(organizationPrincipal, groupId, null, null, Optional.of(new OffsetDateTimeParam(since)), "respond-async");
        assertEquals(Response.Status.ACCEPTED.getStatusCode(), response.getStatus(), "Expected ACCEPTED response code");
    ...
    public void testExportWithInvalidTimes(){
        ...
        WebApplicationException exception = Assertions.assertThrows(WebApplicationException.class, () ->{
                ...
                resource.export(organizationPrincipal, groupId, null, null, Optional.of(new OffsetDateTimeParam(since)), "respond-async");
            });
