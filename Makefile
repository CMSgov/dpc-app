...
.PHONY: int-tests
int-tests: 
	@docker compose $(DOCKER_PROJ) -f docker-compose.yml -f docker-compose.override.yml up tests
	@docker compose $(DOCKER_PROJ) -f docker-compose.yml -f docker-compose.override.yml down

.PHONY: int-tests-cicd
int-tests-cicd: 
	@TEST_VERBOSITY=true docker compose $(DOCKER_PROJ) -f docker-compose.yml -f docker-compose.override.yml up --exit-code-from tests tests
	@docker compose $(DOCKER_PROJ) -f docker-compose.yml -f docker-compose.override.yml down
