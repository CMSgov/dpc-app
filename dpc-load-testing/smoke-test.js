...
import { checkPatientEverythingWorkflow } from './smoke_test_workflows/patient_everything.js';
import { checkPatientExportWorkflow } from './smoke_test_workflows/patient_export.js'
...
export function runSmokeTests(data) {
  ...
  checkPatientEverythingWorkflow(iterationData);
  checkPatientExportWorkflow(iterationData);
}
