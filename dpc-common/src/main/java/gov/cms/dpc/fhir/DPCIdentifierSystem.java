...
public enum DPCIdentifierSystem {
    ...
    CCW("https://bluebutton.cms.gov/resources/variables/bene_id"),
    HICN("http://hl7.org/fhir/sid/us-medicare"),
    HICN_HASH("https://bluebutton.cms.gov/resources/identifier/hicn-hash"),
