...
public abstract class AbstractFHIRExceptionHandler<E extends Throwable> extends LoggingExceptionMapper<E> {
    ...
    protected boolean isFHIRResource(@Context ResourceInfo info) {
        return (info.getResourceClass() != null && info.getResourceClass().getAnnotation(FHIR.class) != null) ||
                (info.getResourceMethod() != null && info.getResourceMethod().getAnnotation(FHIR.class) != null);
    }
