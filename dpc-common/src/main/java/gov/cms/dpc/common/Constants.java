...
public final class Constants {
    ...
    public interface BlueButton {
        String ORIGINAL_QUERY_ID_HEADER = "BlueButton-OriginalQueryId";
        String ORIGINAL_QUERY_TIME_STAMP_HEADER = "BlueButton-OriginalQueryTimestamp";
        String BULK_CLIENTNAME_HEADER = "BULK-CLIENTNAME";
        String APPLICATION_NAME_HEADER = "BlueButton-Application";
        String APPLICATION_NAME_DESC = "DPC";
    }
}
