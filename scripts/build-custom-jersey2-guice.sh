...
# Step 4: Install the artifacts in the custom repository (./repo)
...
echo -n "	Step 5: Generating checksums for the project..."
...
# Step 7: Cleanup the cloned jersey2-guice repo
echo -n "	Step 7: Removing the cloned jersey2-guice repo...";
